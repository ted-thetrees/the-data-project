# The Data Project — v001

> **Status: Retired.** This version used Teable and Baserow as the data management layer. It has been superseded by [v002](../v002/), which uses Supabase directly with bidirectional Coda sync. The Next.js app code in `app/` is still deployed but the Teable write path is no longer active.
