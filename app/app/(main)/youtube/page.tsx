...
const getCachedYouTubeRecords = unstable_cache(getYouTubeRecords, ["youtube-records-v1"], {
  tags: ["inbox"],
  revalidate: 30,
});
const getCachedYouTubeCount = unstable_cache(getYouTubeCount, ["youtube-count-v1"], {
  tags: ["inbox"],
  revalidate: 30,
});
...
export default async function YouTubePage() {
  const [records, count] = await Promise.all([
    getCachedYouTubeRecords(50),
    getCachedYouTubeCount(),
  ]);
