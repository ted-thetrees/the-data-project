// PGP Word List — 512 words designed by computational linguist Patrick Juola
// for maximum phonetic distinctiveness when read aloud.
// Two-syllable words (even) and three-syllable words (odd).

export const evenWords = [
...
// Combined flat list for simple random selection
export const allWords = [...evenWords, ...oddWords];
